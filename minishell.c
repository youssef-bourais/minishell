...
//     if (head == NULL) // if head equall null then there is no node in the linked list 
//     {
//         head = new_node;
//         new_node->next = NULL;
//     }
//     else // we will eaterite over the linked list if we find the null then it's the last node in the linked list ,and then we will add the new_node to the end of the linked list
//     {
//         last = head;
//         while (last->next != NULL)
//             last = last->next; // point to the next node;
//         new_node->next = NULL;
//     }
// }
